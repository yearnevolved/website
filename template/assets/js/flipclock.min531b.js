    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        showSeconds: !0, constructor: function (a, b) {
            ...
            b = b ? b : this.factory.time.getDayCounter(this.showSeconds), b.length > d.length && a.each(b, function (a, b) {
                c.createList(b)
            }), this.showSeconds ? a(this.createDivider(stm_flipclocks_labels.seconds)).insertBefore(this.lists[this.lists.length - 2].$el) : e = 2, a(this.createDivider(stm_flipclocks_labels.minutes)).insertBefore(this.lists[this.lists.length - 4 + e].$el), a(this.createDivider(stm_flipclocks_labels.hours)).insertBefore(this.lists[this.lists.length - 6 + e].$el), a(this.createDivider(stm_flipclocks_labels.days, !0)).insertBefore(this.lists[0].$el), this.base()
        }, flip: function (a, b) {
